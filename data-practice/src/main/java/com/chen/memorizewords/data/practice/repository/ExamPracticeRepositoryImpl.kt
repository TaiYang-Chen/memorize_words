...
import com.chen.memorizewords.data.practice.remoteapi.api.practice.ExamPracticeSessionItemAnswerDto
...
private fun com.chen.memorizewords.data.practice.remoteapi.api.practice.WordExamItemDto.toEntity(cachedAt: Long): ExamPracticeItemEntity {
...
private fun com.chen.memorizewords.data.practice.remoteapi.api.practice.WordExamItemDto.toDomain(): WordExamItem {
    return WordExamItem(
        id = id,
        wordId = wordId,
        questionType = parseQuestionType(questionType),
