...
| 本地与同步 | 学习记录先落本地；联网后由待同步队列和 Worker 重试 | [`SyncOutboxStore.kt`](../../data-sync/src/main/java/com/chen/memorizewords/data/sync/repository/sync/SyncOutboxStore.kt)、[`SyncOutboxDrainWorker.kt`](../../data-sync/src/main/java/com/chen/memorizewords/data/sync/repository/sync/SyncOutboxDrainWorker.kt) | 不说全部数据实时云同步或全功能离线 |
