package com.chen.memorizewords.domain.word.repository
...
interface WordRepository { // 只负责单词数据
    ...
    suspend fun getWordDefinitions(wordId: Long): kotlin.collections.List<com.chen.memorizewords.domain.word.model.word.WordDefinitions>
