...
object FileDownloadWorkConstants {
    ...
    const val ACTION_PAUSE = "com.chen.memorizewords.data.sync.download.ACTION_PAUSE"
    const val ACTION_RESUME = "com.chen.memorizewords.data.sync.download.ACTION_RESUME"
    const val ACTION_CANCEL = "com.chen.memorizewords.data.sync.download.ACTION_CANCEL"
