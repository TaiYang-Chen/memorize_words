package com.chen.memorizewords.data.sync.remote.datasync
...
import com.chen.memorizewords.data.sync.remoteapi.api.datasync.StudyPlanDto
import com.chen.memorizewords.data.sync.remoteapi.api.datasync.UserDataSyncRequest
...
class RemoteUserSyncDataSourceImpl @Inject constructor(
    ...
    override suspend fun redeemMembershipCode(code: String): Result<MembershipRedeemResultDto> {
        return remoteResultAdapter.toResult { request.redeemMembershipCode(code) }
    }
}
