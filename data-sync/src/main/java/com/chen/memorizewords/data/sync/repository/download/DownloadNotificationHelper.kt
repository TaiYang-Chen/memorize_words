package com.chen.memorizewords.data.sync.repository.download
...
object DownloadNotificationHelper {
    ...
    private fun resolveCompletionContent(request: DownloadRequest): String {
        return when (request.completionAction) {
            com.chen.memorizewords.domain.wordbook.model.download.DownloadCompletionAction.OpenFile -> "下载完成，点击打开"
            com.chen.memorizewords.domain.wordbook.model.download.DownloadCompletionAction.InstallApk -> "下载完成，点击处理安装"
            com.chen.memorizewords.domain.wordbook.model.download.DownloadCompletionAction.None -> "下载完成"
        }
    }
    ...
    private fun completionIntent(
        ...
        return when (request.completionAction) {
            com.chen.memorizewords.domain.wordbook.model.download.DownloadCompletionAction.None -> null
            com.chen.memorizewords.domain.wordbook.model.download.DownloadCompletionAction.OpenFile ->
                buildOpenFileIntent(context, file, request.mimeType)

            com.chen.memorizewords.domain.wordbook.model.download.DownloadCompletionAction.InstallApk ->
