...
object AgreementDocuments {
        ...
        return AgreementDocument(
            ...
            sections = listOf(
                AgreementSection(
                    title = "一、我们如何收集和使用信息",
                    paragraphs = listOf(
                        "小白背单词会根据你主动使用的功能收集必要信息，包括账号信息、登录状态、学习计划、学习进度、练习记录、收藏与笔记、反馈内容、设备网络状态以及应用更新状态。",
    ...
    private fun terms(): AgreementDocument {
        return AgreementDocument(
            ...
            version = "v1.0",
            summary = listOf(
                "本协议适用于你使用小白背单词提供的账号、词书、学习、练习、同步、反馈和应用更新等服务。",
            ...
            sections = listOf(
                AgreementSection(
                    title = "一、服务说明",
                    paragraphs = listOf(
                        "小白背单词为用户提供词书学习、复习计划、练习测试、语音跟读、学习记录、账号同步、意见反馈和应用更新等功能。",
